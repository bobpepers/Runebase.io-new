...
var ParticleWave = function()
{
    ...
    {
        particle = new Float32Array(config.particleCount * 3);
    ...
    {
        var canvas = document.getElementById("particlewave");

        engine = canvas.getContext('2d');

        width  = window.innerWidth;
        height = document.getElementById('pariclewaveHeight').clientHeight;
        console.log(document.getElementById('particlewave').clientHeight);
    ...
    {
        randomWalker += (Math.random() - 0.5) * 0.03;

        particleWaveWalker += 0.009;
