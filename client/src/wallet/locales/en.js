export default {
  ...
  restore_ledger: {
    ...
    usage: 'Please ensure your firmware and app are the newest version. Plugin your Ledger, open Runebase APP, and then click the "CONNECT" button below try to connect.',
    download: 'No Runebase APP? Please install it follow this https://www.ledgerwallet.com/apps/manager',
    connect: 'CONNECT',
  },
  view: {
